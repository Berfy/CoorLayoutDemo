...
public class Coor2Layout extends LinearLayout {
    ...
    public Coor2Layout(Context context) {
        this(context, null, 0);
    }

    public Coor2Layout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Coor2Layout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
